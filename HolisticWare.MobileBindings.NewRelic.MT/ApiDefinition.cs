...
namespace HolisticWare.MobileBindings.NewRelic.MT
{
	...
	# region    HolisticWare Automagically Generated Code
	//-------------------------------------------------------------------------
	// HolisticWare http://holisticware.net
	// created by parser.exe
	//	https://github.com/moljac/monotouch-binding-generator
	// see
	//	.\0-docs\generate-bindings.bat
	...
	//-------------------------------------------------------------------------
	# endregion HolisticWare Automagically Generated Code
